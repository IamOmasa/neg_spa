      ...
      aboutCards: [
        {
          id: 1,
          title: 'WHO WE ARE',
          text: 'We are highly motivated and experienced agriculture specialists and farmers working as a team to create a better future for the agriculture sector in Tanzania and Africa at large.',
          icon: 'UsersIcon'
        },
        {
          id: 2,
          title: 'Mission',
          text: 'To provide quality and affordable agriculture services using the best technologies to solve agriculture and environmental problems.',
          icon: 'TargetIcon'
        },
        {
          id: 3,
          title: 'Vision',
          text: 'To be the Leading company in providing Smart agriculture services, solutions and technology in the World.',
          icon: 'EyeIcon'
        }
      ],
      services: [
        {
          ...
          description: 'Modern irrigation solutions and farm structures for optimal water management.',
          image: 'https://images.unsplash.com/photo-1560493676-04071c5f467b?w=800'
        },
        {
          id: 2,
          title: 'Farm Management',
          description: 'Professional farm management services to maximize your agricultural productivity.',
          image: 'https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=800'
        },
        {
          id: 3,
          title: 'Extension Services',
          description: 'Expert guidance and support to help you implement best farming practices.',
...
<style scoped>
/* Component-specific styles - isolated from other components */
